...
// Time bar background: 75% toward terminal default from bar bg (subtler than usage bars).
...
function computeTimeBarBg(rawBg, dark, truecolor) {
  ...
  const blend = 0.75; // 0 = same as bar bg, 1 = terminal default
  if (isRgbStop(rawBg)) {
    const mid = [
  ...
  // Shift index 75% toward terminal default end of the grayscale ramp.
