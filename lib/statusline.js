...
function getBarConfig() {
  ...
  _barConfig = { width, emptyBg, gradient, truecolor, isRgb, partialBlocks: usePartialBlocks };
  return _barConfig;
}
...
function testColors() {
  ...
  console.log(`Mode: ${dark ? 'dark' : 'light'}, Color: ${tc ? 'truecolor' : '256-color'}, Width: ${config.width}, Partial blocks: ${config.partialBlocks ? 'on' : 'off'}`);
  console.log();
