 ...
 */
function renderLines({ context, model, tier, elapsed, profile, profileColor, fiveHour, weekly, extraUsage, stale, lastSuccessTs, git, lines: lineChanges, cwd, fiveHourTimePercent, weeklyTimePercent }) {
  const config = getBarConfig();
  const lines = [];
