...
function getBarConfig() {
  ...
  _barConfig = { width, emptyBg, gradient, truecolor, isRgb, partialBlocks: usePartialBlocks, orientation, cwdMaxLength, cwdDepth };
  return _barConfig;
}
 ...
 */
function renderLines({ context, model, tier, elapsed, profile, profileColor, fiveHour, weekly, extraUsage, stale, git, lines: lineChanges, cwd }) {
  const config = getBarConfig();
  const lines = [];
